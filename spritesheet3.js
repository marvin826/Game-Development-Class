...
SpriteSheetClass = Class.extend({
    ...
    parseAtlasDefinition: function (atlasJSON) {
        ...
        for(var key in parsed.frames) {
            ...
            //
            // 1) The dimensions of the trimmed image (same as the frame 
            //    width and height
            // 2) Where in the original image the trimmed image's upper
            //    left corner is relative to the original's upper left
            //    corner
            //
            // 'sourceSize' defines:
            //
            // 1) The original dimensions of the image before trimming
            //
